...
// VC Trainers ------------------------------------------------------------------------ >
function ttbase_framework_vc_trainer_grid_shortcode() {
	
	vc_map( array(
		'name'				=> esc_html__( 'TTBase Trainers Grid', 'ttbase-framework' ),
		'base'				=> 'ttbase_trainer_grid',
		'description'		=> esc_html__( 'Show your trainers in a grid style.', 'ttbase-framework' ),
		...
		'params'			=> array(
			...
			array(
				"type" => "textfield",
				"heading" => esc_html__("Number of trainer", 'ttbase-framework'),
				"param_name" => "trainers",
				"value" => '6'
			),
			array(
			...
			array(
				'type'			=> 'textfield',
				'heading'		=> esc_html__( 'Image Width', 'ttbase-framework' ),
				'param_name'	=> 'img_width',
				'description'	=> esc_html__( 'Enter a width in pixels.', 'ttbase-framework' ),
			),
			array(
				'type'			=> 'textfield',
				'heading'		=> esc_html__( 'Image Height', 'ttbase-framework' ),
...
add_action( 'vc_before_init', 'ttbase_framework_vc_trainer_grid_shortcode' );
