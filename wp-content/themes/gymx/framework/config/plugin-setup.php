	...
	function gymx_register_plugins() {
		...
		$plugins = array(
			array(
				...
				'source'             => 'http://helpdesk.themetwins.com/download/ttbase-framework-gymx-latest/', // The plugin source
				...
				'external_url'       => 'http://helpdesk.themetwins.com/download/ttbase-framework-gymx-latest/', // If set, overrides default API URL and points to an external URL
			),
			array(
				'name'               => esc_attr__('WPBakery Visual Composer', 'gymx'), // The plugin name
