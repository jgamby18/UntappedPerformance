	...
	*/
	public function gymx_customize_common_register () {
        ...
        */
		...
		$this->wp_customize->add_setting( 'gymx_show_pagetitle_separator', array( 'default' => 'no', 'sanitize_callback' => 'gymx_sanitize_choices' ) );
		$this->wp_customize->add_control( 'gymx_show_pagetitle_separator', array(
			'type'        => 'select',
			'priority'    => 45,
			'label'       => esc_html_x( 'Show Page Title Separator?', 'backend', 'gymx' ),
			'description' => esc_html_x( 'Show or hide page title separator for all pages.', 'backend', 'gymx' ),
			'section'     => 'gymx_section_page_title',
			'choices'     => array(
				'yes' => esc_html_x( 'Yes', 'backend', 'gymx' ),
				'no'  => esc_html_x( 'No', 'backend', 'gymx' )
		...
		$this->wp_customize->add_setting( new GymX_Customize_CSS( $this->wp_customize, 'gymx_pagetitle_underline_color', array(
			'default'	=> '#f48460',
			'sanitize_callback' => 'sanitize_hex_color',
			'css_map' => array(
				'border-color' => array(
		...
		$this->wp_customize->add_control( new WP_Customize_Color_Control(
			$this->wp_customize,
			'gymx_pagetitle_underline_color',
			array(
				'priority' => 50,
				'label'    => esc_html_x( 'Page title separator color', 'backend', 'gymx' ),
				'section'  => 'gymx_section_page_title',
			)
		) );
		...
		$this->wp_customize->add_setting( new GymX_Customize_CSS( $this->wp_customize, 'gymx_primary_color', array(
			...
			'css_map'			=> array(
				'color' => array(
					...
					'a.ttbase-imagebox .ttbase-imagebox-heading i',
					'a.ttbase-imagebox .ttbase-imagebox-subtitle',
					'a.ttbase-class-item-image .ttbase-class-item-heading i',
					'a.ttbase-class-item-image .ttbase-class-item-subtitle',
					'.ttbase-gallery.style-1 .image-title i',
					'a.ttbase-trainer-item-image .ttbase-trainer-item-heading i',
				...
				'background-color' => array(
					...
					'a.ttbase-trainer-item-image:hover .ttbase-trainer-item-image-content',
        ...
        $this->wp_customize->add_setting( 'gymx_button_style', array( 'default' => 'style-2', 'sanitize_callback' => 'gymx_sanitize_choices' ) );
		...
		$this->wp_customize->add_setting( 'gymx_show_footer_title_separator', array( 'default' => 'no', 'sanitize_callback' => 'gymx_sanitize_choices' ) );
		$this->wp_customize->add_control( 'gymx_show_footer_title_separator', array(
			'type'        => 'select',
			'priority'    => 28,
			'label'       => esc_html_x( 'Show Footer Widget Title Separator?', 'backend', 'gymx' ),
			'description' => esc_html_x( 'Show or hide title separator for the footer widgets.', 'backend', 'gymx' ),
			'section'     => 'gymx_section_footer',
			'choices'     => array(
				'yes' => esc_html_x( 'Yes', 'backend', 'gymx' ),
				'no'  => esc_html_x( 'No', 'backend', 'gymx' )
		...
		$this->wp_customize->add_setting( new GymX_Customize_CSS( $this->wp_customize, 'gymx_footer_title_separator_color', array(
			'default' => '#f48460',
			'sanitize_callback' => 'sanitize_hex_color',
			'css_map' => array(
				'border-color' => array(
		...
		$this->wp_customize->add_control( new WP_Customize_Color_Control(
			$this->wp_customize,
			'gymx_footer_title_separator_color',
			array(
				'priority' => 30,
				'label'    => esc_html_x( 'Footer widgets title separator color', 'backend', 'gymx' ),
				'section'  => 'gymx_section_footer',
			)
		) );
		...
		$this->wp_customize->add_setting( 'gymx_footer_text', array( 'default' => 'Copyright 2017 by themetwins. GymX Theme crafted with love.', 'sanitize_callback' => false ) );
