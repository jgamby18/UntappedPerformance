...
function gymx_scripts() {
    wp_enqueue_style( 'gymx-fonts', gymx_fonts_url(), array(), '1.0.1' );
    ...
    wp_enqueue_style( 'gymx-theme', get_stylesheet_directory_uri() . '/css/theme.min.css', array(), '1.0.4' );
    ...
    wp_enqueue_script( 'gymx-scripts', get_template_directory_uri() . '/js/scripts.min.js', array('jquery'), '20161205', true );
    wp_enqueue_script( 'gymx-js', get_template_directory_uri() . '/js/gymx-main.min.js', array('jquery', "jquery-ui-core", 'jquery-ui-accordion', 'jquery-ui-tabs', 'gymx-scripts', 'bootstrap-filestyle'), '20170410', true );
